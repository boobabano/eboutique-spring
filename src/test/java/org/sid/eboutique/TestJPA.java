...
public class TestJPA {
	...
	public void test1() {
		try {
			...
			metier.ajouterCategorie(new Categorie("Ordinateurs", "qwerty123", null, "image.jpg"));
			metier.ajouterCategorie(new Categorie("Imprimantes", "hewletpackard", null, "image.jpg"));
	...
	public void test2() {
		try {
			...
			metier.ajouterProduit(new Produit("HP45ERT", "SAMSUNG776", 5000, true, "image1.jpg", 100),1L);
			metier.ajouterProduit(new Produit("AZERTY", "SONYWALKMAN", 2456, true, "image2.jpg", 27),1L);
